...
int main(int argc, char **argv)
{
    ...
    float *restrict a = aligned_alloc(128, M * K * sizeof(float));
    float *restrict b = aligned_alloc(128, K * N * sizeof(float));
    float *restrict out = aligned_alloc(128, M * N * sizeof(float));

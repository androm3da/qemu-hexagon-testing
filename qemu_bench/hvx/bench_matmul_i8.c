...
int main(int argc, char **argv)
{
    ...
    int8_t *restrict a = aligned_alloc(128, M * K * sizeof(int8_t));
    int8_t *restrict b = aligned_alloc(128, K * N * sizeof(int8_t));
    int8_t *restrict out = aligned_alloc(128, M * N * sizeof(int8_t));

...
int main(int argc, char **argv)
{
    ...
    __fp16 *restrict a = aligned_alloc(128, M * K * sizeof(__fp16));
    __fp16 *restrict b = aligned_alloc(128, K * N * sizeof(__fp16));
    __fp16 *restrict out = aligned_alloc(128, M * N * sizeof(__fp16));
